...
SECRET_KEY = 'django-insecure-r(=_tlx)5==(=*va1w#^mequ@ftq5)w4aq4d3prf(1^&xm#r_v'
...
INSTALLED_APPS = [
    ...
    'Authentication_manager.apps.AuthenticationManagerConfig',
    'user_manager',
    'allauth',
    'allauth.account',
...
AUTHENTICATION_BACKENDS = [
    ...
    # ...plus any other authentication backend you want to use.
